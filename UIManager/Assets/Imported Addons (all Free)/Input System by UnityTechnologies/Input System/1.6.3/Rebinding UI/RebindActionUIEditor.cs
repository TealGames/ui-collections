...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            /*
            m_ChangeMiceBindingsToSpritesProperty = serializedObject.FindProperty("m_ChangeMiceBindingsToSprite");
            m_ChangeAllBindingsToSpritesProperty = serializedObject.FindProperty("m_ChangeAllBindingsToSprites");
            m_BindingSriteImageProperty = serializedObject.FindProperty("m_BindingSriteImage");
            m_LeftMouseSpriteProperty = serializedObject.FindProperty("m_LeftMouseSprite");
            m_RightMouseSpriteProperty = serializedObject.FindProperty("m_RightMouseSprite");
            m_MiddleMouseSpriteProperty = serializedObject.FindProperty("m_MiddleMouseSprite");
            */
        ...
        public override void OnInspectorGUI()
        {
            ...
            //custom mouse and binding sprite section
            EditorGUILayout.Space();

            /*
            EditorGUILayout.LabelField(m_MouseSpriteLabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                //custom property fields
                EditorGUILayout.PropertyField(m_ChangeMiceBindingsToSpritesProperty);
                EditorGUILayout.PropertyField(m_ChangeAllBindingsToSpritesProperty);
                EditorGUILayout.PropertyField(m_BindingSriteImageProperty);
                EditorGUILayout.PropertyField(m_RightMouseSpriteProperty);
                EditorGUILayout.PropertyField(m_MiddleMouseSpriteProperty);
                EditorGUILayout.PropertyField(m_LeftMouseSpriteProperty);
            }
            */
        ...
        /*
        private SerializedProperty m_ChangeMiceBindingsToSpritesProperty;
        private SerializedProperty m_ChangeAllBindingsToSpritesProperty;
        private SerializedProperty m_BindingSriteImageProperty;
        private SerializedProperty m_LeftMouseSpriteProperty;
        private SerializedProperty m_RightMouseSpriteProperty;
        private SerializedProperty m_MiddleMouseSpriteProperty;
        */
        ...
        //custom field
        //private GUIContent m_MouseSpriteLabel = new GUIContent("Binding Sprites");
